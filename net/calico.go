  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        - name: upgrade-ipam
          image: registry.cn-beijing.aliyuncs.com/k7scn/calico-cni:v3.14.0
        ...
        - name: flexvol-driver
          image: registry.cn-beijing.aliyuncs.com/k7scn/calico-pod2daemon-flexvol:v3.14.0
          volumeMounts:
      ...
      containers:
        ...
        # host.
        - name: calico-node
          image: registry.cn-beijing.aliyuncs.com/k7scn/calico-node:v3.14.0
          env:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: calico-kube-controllers
          image: registry.cn-beijing.aliyuncs.com/k7scn/calico-kube-controllers:v3.14.0
          env:
