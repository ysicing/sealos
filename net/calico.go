  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        - name: upgrade-ipam
          image: hub.51talk.com/calico/cni:v3.13.3
        ...
        - name: flexvol-driver
          image: hub.51talk.com/calico/pod2daemon-flexvol:v3.13.3
          volumeMounts:
      ...
      containers:
        ...
        # host.
        - name: calico-node
          image: hub.51talk.com/calico/node:v3.13.3
          env:
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: calico-kube-controllers
          image: hub.51talk.com/calico/kube-controllers:v3.13.3
          env:
